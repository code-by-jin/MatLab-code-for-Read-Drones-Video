...
%     altitude = strtrim(string(txt_altitude.Text));
    ...
    I = rgb2gray(frame);
    [center_left] = imfindcircles(I(1:300, 100:300),[25 35], 'ObjectPolarity','dark', 'Sensitivity', 0.9);
    [center_right] = imfindcircles(I(1:300, 800:1100),[25 35], 'ObjectPolarity','dark', 'Sensitivity', 0.9);
